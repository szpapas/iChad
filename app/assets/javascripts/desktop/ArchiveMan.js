...
Ext.define('MyDesktop.ArchiveMan', {
	...
	createWindow : function(){
	   ...
	   //  new Ajax.Request("/desktop/get_dalb", { 
	   //  	method: "POST",
	   ...
	   //  				break; 
	   //  			case "3": 
	   //	     		archiveGrid.columns[6].dataIndex="djh";
	   //	     		archiveGrid.columns[6].text="地籍号";
	   //	     		//archiveGrid.columns[6].width="75";
	   //	     	  	archiveGrid.columns[7].dataIndex="qlr";
	   //	  			//archiveGrid.columns[7].width="75";
	   //	     	  	archiveGrid.columns[7].text="权利人名称";
	   //  			//   
	   //  			//   archiveGrid.columns[8].dataIndex="zl";
	   //  			//   archiveGrid.columns[8].width="75";
	   //  			//   archiveGrid.columns[8].text="土地座落";
	   //  			//   break; 
	   //  			default:
	   //  				
	   //  				break;
