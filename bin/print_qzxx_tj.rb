...
def print_qzxx(dh_prefix)
  ...
  convert_str =  "convert ./dady/timage_t3.png -font ./dady/STZHONGS.ttf  -pointsize 24 -draw \"text 610, 560 '#{mlh}' \" -draw \"text 290, 620 '#{dd['qajh']} ~ #{dd['zajh']}' \"  -draw \"text 610, 620 '#{ajs}' \" /share/tjsj/tj_#{dh_prefix}_02.jpg  "
  system convert_str
