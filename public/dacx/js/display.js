...
$(document).ready(function() {
	...
	jCollage.setBackgroundColor("#ccc");
	
	//jCollage.addLayer('<img src="./bar/10_bar-refaeli_01.jpg">').setTitle("0_bar-refaeli");
	updateLayers(jCollage.getLayers());
	$("#layer_" + (jCollage.getLayers().length - 1)).addClass("selected");
	
	$(".search img").live("click", function() {
	  if (jCollage.getLayers().length>0) {
		  jCollage.removeLayer(0);
		};
